...
feature "visitor signs up", :js => true do
  scenario "should sign them up with valid details" do
    visit '/'
    within '#signup' do
  ...
  scenario "should not sign them up with invalid details" do
    visit '/'
    within '#signup' do
      fill_in 'First Name', :with => "Tom"
      fill_in 'Last Name', :with => "Wissy"
  ...
  scenario "should not sign them up if no details are provided" do
    visit '/'
    within '#signup' do
      click_button 'Sign Up'
    end
...
feature "User logs in", :js => true do
  scenario "should log them in with valid details" do
    visit '/'
    within '#signup' do
      fill_in 'First Name', :with => "Tom"
      fill_in 'Last Name', :with => "Wissy"
  ...
  scenario "should not log them in with invalid details" do
    visit '/'
    within '#signup' do
      fill_in 'First Name', :with => "Tom"
      fill_in 'Last Name', :with => "Wissy"
  ...
  scenario "should increment the login count with each login" do
    visit '/'
    within '#signup' do
      fill_in 'First Name', :with => "Tom"
      fill_in 'Last Name', :with => "Wissy"
